...
public class Questions {//문의게시판
	...
	public String toString() {
		return "Questions [boType=" + boType + ", cateName=" + cateName + ", boNo=" + boNo + ", boPwd=" + boPwd
				+ ", boTitle=" + boTitle + ", boContent=" + boContent + ", boCount=" + boCount + ", boDate=" + boDate
				+ ", boDeleteYn=" + boDeleteYn + ", memNo=" + memNo + ", memId=" + memId + ", memLeave=" + memLeave
				+ ", comContent=" + comContent + ", comDate=" + comDate + ", filePath=" + filePath + ", originName="
